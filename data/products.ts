...
Garanta já o seu Kit Escolar Patrulha Canina e volte às aulas com os heróis mais fofos da TV!`,
  ...
  {
    id: "15",
    name: "Kit Estojo Desenho 146 Lápis Profissional Colorido Realista",
...
Conforto na escrita.`,
  ...
  },
  {
    ...
    price: 7.9,
    image: "https://i.postimg.cc/NGXN7rc1/image.png",
    images: ["https://i.postimg.cc/NGXN7rc1/image.png"],
    category: "Canetas",
    categorySlug: "canetas",
    brand: "BRW",
...
Cores Verde e Branca, criado exclusivamente para a torcida alviverde.`,
  ...
  {
    id: "126",
    name: "Caderno Inteligente São Paulo Tricolor Paulista De Disco",
...
Conjunto completo de materiais necessários para atividades escolares.`,
  ...
  {
    id: "129",
    name: "Kit 6 Canetas Coloridas Gel Tris Glitter Pastel",
    slug: "kit-6-canetas-coloridas-gel-tris-glitter-pastel",
    price: 19.9,
    image: "https://i.postimg.cc/mDbPc7cp/image.png",
    images: [
      "https://i.postimg.cc/mDbPc7cp/image.png",
      "https://i.postimg.cc/TPHq6nZf/image.png",
      "https://i.postimg.cc/WtZwC0Tx/image.png",
    ],
    category: "Lápis e Canetas",
    categorySlug: "lapis-canetas",
    brand: "Tris",
    description: `Kit com 6 canetas coloridas de gel com glitter pastel.
Cores sortidas em tons pastel brilhantes.
Ponta 1,0 mm.`,
    specifications: [
      { label: "Gênero", value: "Unissex" },
      { label: "Material", value: "Plástico, Tinta Gel com Glitter" },
      { label: "Tipo de estilo", value: "Escolar, Decoração" },
      { label: "Características", value: "Glitter pastel, 6 cores" },
    ],
    rating: 4.6,
    reviews: 123,
    inStock: true,
...
Dá um toque de estilo, personalidade e alegria à rotina de escrita.`,
  ...
  {
    id: "132",
    name: "Kit Mochila Escolar Homem Aranha Lancheira Estojo Reforçada",
    slug: "kit-mochila-escolar-homem-aranha-lancheira-estojo-reforcada",
    price: 79.9,
    image: "https://i.postimg.cc/cH5qNNfw/image.png",
    images: ["https://i.postimg.cc/cH5qNNfw/image.png", "https://i.postimg.cc/zv99VStz/image.png"],
    category: "Mochilas",
    categorySlug: "mochilas",
    brand: "EscolaShop",
    description: `Kit Mochila Escolar Homem Aranha com Lancheira e Estojo.
Rodinhas de silicone e alças bem resistentes.
Desenhos estampados super bonitos.`,
    specifications: [
      { label: "Gênero", value: "Meninos/Crianças" },
      { label: "Material", value: "Poliéster" },
      { label: "Tipo de estilo", value: "Escolar, Temático (Marvel)" },
      { label: "Conteúdo", value: "Mochila de rodinhas, Lancheira, Estojo" },
    ],
    rating: 4.7,
    reviews: 145,
    inStock: true,
    isBestSeller: false,
    isOnSale: false,
    colorVariants: [{ name: "Vermelho Liso (Homem Aranha)", image: "https://i.postimg.cc/cH5qNNfw/image.png" }],
  },
  {
    id: "133",
    name: "Kit Mochila Lancheira Garrafa Estojo Homem Aranha Marvel",
    slug: "kit-mochila-lancheira-garrafa-estojo-homem-aranha-marvel",
    price: 99.9,
    image: "https://i.postimg.cc/3J2K2dgB/image.png",
    images: [
      "https://i.postimg.cc/3J2K2dgB/image.png",
      "https://i.postimg.cc/N0jBhDWj/image.png",
      "https://i.postimg.cc/XJTbCbq1/image.png",
      "https://i.postimg.cc/Xqd0KzyG/image.png",
      "https://i.postimg.cc/GhnR3dZy/image.png",
      "https://i.postimg.cc/SKRF1sz5/image.png",
      "https://i.postimg.cc/tCNKXPdR/image.png",
    ],
    category: "Mochilas",
    categorySlug: "mochilas",
    brand: "EscolaShop",
    description: `Kit de mochila infantil personalizada com o tema Spider-Man, da Marvel.
Confeccionado em material reforçado, com costuras firmes.
Inclui Mochila, Lancheira, Garrafa e Estojo.`,
    specifications: [
      { label: "Gênero", value: "Meninos/Crianças" },
      { label: "Material", value: "Poliéster" },
      { label: "Tipo de estilo", value: "Escolar, Temático (Marvel)" },
      { label: "Dimensões Mochila", value: "45x32x18cm (25L)" },
    ],
    rating: 4.8,
    reviews: 203,
    inStock: true,
    isBestSeller: true,
    isOnSale: false,
    colorVariants: [{ name: "Preto (Homem Aranha)", image: "https://i.postimg.cc/3J2K2dgB/image.png" }],
  },
  {
    id: "134",
    name: "Kit Mochila Rodinha Marvel Lancheira Estojo Escolar Infantil",
    slug: "kit-mochila-rodinha-marvel-lancheira-estojo-escolar-infantil",
    price: 89.9,
    image: "https://i.postimg.cc/2yftY8VL/image.png",
    images: [
      "https://i.postimg.cc/2yftY8VL/image.png",
      "https://i.postimg.cc/pVD7Z86j/image.png",
      "https://i.postimg.cc/T1GtS74D/image.png",
      "https://i.postimg.cc/J7c6J8ss/image.png",
    ],
    category: "Mochilas",
    categorySlug: "mochilas",
    brand: "EscolaShop",
    description: `Kit Mochila de Rodinha Marvel com Lancheira e Estojo.
Alças traseiras acolchoadas (uso como mochila de costas).
1 compartimento principal amplo com fechamento em zíper duplo.`,
    specifications: [
      { label: "Gênero", value: "Unissex" },
      { label: "Material", value: "Poliéster" },
      { label: "Tipo de estilo", value: "Escolar, Temático (Marvel)" },
      { label: "Dimensões Mochila", value: "42x30x18cm (22L)" },
    ],
    rating: 4.6,
    reviews: 178,
    inStock: true,
    isBestSeller: false,
    isOnSale: false,
    colorVariants: [{ name: "Azul (Marvel)", image: "https://i.postimg.cc/2yftY8VL/image.png" }],
  },
  {
    id: "135",
    name: "Kit 50 Itens Papelaria Fofa Caixa Surpresa",
    slug: "kit-50-itens-papelaria-fofa-caixa-surpresa",
    price: 59.9,
    image: "https://i.postimg.cc/MZjFJhD9/br-11134207-7r98o-m7s3r6wb4w445d.webp",
    images: [
      "https://i.postimg.cc/MZjFJhD9/br-11134207-7r98o-m7s3r6wb4w445d.webp",
      "https://i.postimg.cc/X7jdk5r6/br-11134207-81z1k-mew667hrqz9f28.webp",
    ],
    category: "Kits",
    categorySlug: "kits",
    brand: "EscolaShop",
    description: `Bem vindos a nossa loja! Nossa loja na Shopee de artigos de papelaria fofa está cheia de produtos encantadores para transformar o dia a dia em uma experiência colorida e cheia de alegria. Explore nossa coleção e descubra itens perfeitos para todas as idades!

Kit Papelaria fofa Caixa Surpresa Kawaii Kit Escolar papelaria criativa papelaria divertida Presente Aniversário

Caixa Supreme Contém (51 itens):
7 Cartelas de Adesivos Divertidos
1 Apontador
1 Lápis com Borracha na Ponta
1 Borracha Bastão
1 Caneta 6 Cores Divertida
4 Caneta Ball Point
2 Caneta Divertida
6 Caneta Fine Line
5 Caneta Gel
5 Caneta Neon Color
6 Caneta Ponta Dupla
1 Corretivo
1 Lapis Infinito c/ Aplique
1 Lapiseira Troca Pontas
2 Bloquinho 20 Folhas (9,5 x 9,5 cm)
2 Borracha Divertidas
1 Marca Texto 3 em 1 Divertido
4 Mini Marca Texto`,
    specifications: [
      { label: "Gênero", value: "Unissex" },
      { label: "Material", value: "Diversos (Plástico, Papel)" },
      { label: "Tipo de estilo", value: "Escolar, Kawaii, Fofo" },
      { label: "Conteúdo", value: "51 itens de papelaria variados" },
    ],
    rating: 4.8,
    reviews: 189,
    inStock: true,
    ...
    isOnSale: false,
    colorVariants: [
      { name: "Caixa Surpresa", image: "https://i.postimg.cc/MZjFJhD9/br-11134207-7r98o-m7s3r6wb4w445d.webp" },
    ],
  },
  {
    id: "140",
    name: "Kit Papelaria Itens Variados",
    slug: "kit-papelaria-itens-variados",
    price: 49.9,
    image: "https://i.postimg.cc/vB7XcdNn/br-11134207-7r98o-lnmgmrgce3f07d.webp",
    images: [
      "https://i.postimg.cc/vB7XcdNn/br-11134207-7r98o-lnmgmrgce3f07d.webp",
      "https://i.postimg.cc/2y8dyLWQ/br-11134207-7r98o-mdv8ltfxnbg9b5.webp",
    ],
    category: "Kits",
    categorySlug: "kits",
    brand: "EscolaShop",
    description: `Kit Papelaria Itens Variados kawai - Fofo - Básico - Escritório

Cada Kit contém vários itens de papelaria, todos de excelente qualidade.
Escolha seu kit no campo VARIAÇÃO.`,
    specifications: [
      { label: "Gênero", value: "Unissex" },
      { label: "Material", value: "Diversos" },
      { label: "Tipo de estilo", value: "Escritório, Kawaii, Básico" },
      { label: "Conteúdo", value: "Itens variados de papelaria" },
    ],
    rating: 4.7,
    reviews: 156,
    inStock: true,
    ...
    isOnSale: false,
    colorVariants: [
      { name: "Kit Variado", image: "https://i.postimg.cc/vB7XcdNn/br-11134207-7r98o-lnmgmrgce3f07d.webp" },
    ],
  },
]
...
export function getBestSellers() {
  // Updated logic to filter products where isBestSeller is true
